		...
		?>
			...
			<table>
				...
				<tr>
					...
					<td>
						<input size="50" type="text" name="txntype" value="Preauth"/> <!--Preauth,payer_auth)-->
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<input size="50" type="text" name="orderid" value="AVIS_ORDER_001" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<td> Assign Token </td>
				<td>
					<input type="text" readonly="readonly" name="assignToken" value="true" /> 
				</td>
				</tr>
				<!--<tr>
					<td>
					...
					<td>
						<input size="50" type="text" name="hosteddataid" value="838708470" />
					</td>
				</tr>-->
				<!--<tr>
					<td>
